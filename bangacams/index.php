...
<main id="primary" class="site-main">
	...
	<section id="trending-section" class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
		...
		<!-- Models Grid (Queries top 6 online/popular models) -->
		<?php
						...
						<div>
							<div class="flex items-center justify-between mb-4">
								<div class="flex items-center space-x-3.5">
									<img src="<?php echo esc_url($logo_url); ?>" alt="<?php the_title_attribute(); ?>" class="h-12 w-12 rounded-xl object-cover border border-zinc-800">
									<div>
